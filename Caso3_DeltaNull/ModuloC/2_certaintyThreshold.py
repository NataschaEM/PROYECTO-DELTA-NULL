...
def solution(s):
    # Pista: define el string de mayúsculas válidas: "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
    # Crea un contador en 0.
    # Recorre s con for y suma 1 si el carácter está en las mayúsculas.
    # Todo: Solution
    pass
